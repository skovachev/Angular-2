...
var ifFalseCase = (function () {
    function ifFalseCase(_vcr, _el, host) {
        this._vcr = _vcr;
        this._el = _el;
        this._host = host;
        this._view = new View_1.View(this._vcr, this._el);
        this._host.registerView(this._view, false);
    }
    __decorate([
        core_1.Host(), 
        __metadata('design:type', ifElseStar_directive_1.ifElseStar)
    ], ifFalseCase.prototype, "_host", void 0);
...
//# sourceMappingURL=ifFalseCase.directive.js.map