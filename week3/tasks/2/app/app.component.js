...
var App = (function () {
    function App(wordsService, usersService) {
    ...
    App = __decorate([
        core_1.Component({
            ...
            providers: [index_1.WordsService, index_1.UsersService]
        }), 
        __metadata('design:paramtypes', [index_1.WordsService, index_1.UsersService])
    ], App);
    return App;
}());
exports.App = App;
